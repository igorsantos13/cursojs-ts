...
/***/ "./src/018-webpack/form-control.ts":
/*!*****************************************!*\
  !*** ./src/018-webpack/form-control.ts ***!
  \*****************************************/
...
const password2 = document.querySelector('.form');
...
function checkEmail(email) {
    if (!(0, isEmail_1.default)(email.value))
        showErrorMessages(email, 'Email inválido');
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/018-webpack/form-control.ts");
console.log('salve');
